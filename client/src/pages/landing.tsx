            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4 ml-6">
                ...
                {isAuthenticated ? (
                  ...
                  <Link href="/auth">
                    <button className="gp-btn-primary pl-[192px] pr-[192px] text-sm pt-[8px] pb-[8px]">
                      Login
                    </button>
                  </Link>
                )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start space-x-8 mb-8">
                ...
                {/* ICLens Logo */}
                <div className="flex items-center space-x-3">
                  <div className="w-16 h-16 rounded-xl flex items-center justify-center shadow-lg ml-[-10px] mr-[-10px] pl-[0px] pr-[0px]" style={{ backgroundColor: 'var(--gp-surface-raised)' }}>
